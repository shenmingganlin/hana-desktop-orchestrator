...
function main() {
  ...
  checks.push(check("helper-dir-present", fs.existsSync(path.join(pluginRoot, "helper"))));
  checks.push(check("helper-hanawin32-present", fs.existsSync(path.join(pluginRoot, "helper", "HanaWin32.dll"))));
  checks.push(check("helper-desktop-helper-present", fs.existsSync(path.join(pluginRoot, "helper", "desktop-helper.exe"))));
  checks.push(check("helper-uia-helper-present", fs.existsSync(path.join(pluginRoot, "helper", "desktop-uia-helper.exe"))));
  ...
  for (const relativePath of REQUIRED_HELPER_FILES) {
