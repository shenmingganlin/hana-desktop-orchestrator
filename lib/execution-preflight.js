...
export function runExecutionPreflight({ recordId } = {}) {
  ...
  addCheck(checks, "approval-bundle-hash-match", Boolean(token?.approvalBundleHash && actualBundleHash && token.approvalBundleHash === actualBundleHash), {
...
function computePreflightStatus(checks, passed, reason) {
  ...
  if (failedNames.includes("approval-bundle-fields-present") || failedNames.includes("approval-bundle-live") || failedNames.includes("approval-bundle-hash-match")) {
