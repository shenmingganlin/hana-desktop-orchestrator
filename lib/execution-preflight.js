...
import { hashApprovalBundle } from "./approval-bundle.js";
...
function computePreflightStatus(checks, passed, reason) {
  ...
  if (failedNames.includes("approval-bundle-fields-present") || failedNames.includes("approval-bundle-live") || failedNames.includes("approval-bundle-hash-present") || failedNames.includes("approval-bundle-hash-integrity") || failedNames.includes("approval-bundle-hash-match")) {
