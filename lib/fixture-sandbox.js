...
function buildFixtureContext({ expired = false, hashMismatch = false, signatureMismatch = false, executable = false, bundleHashMismatch = false, missingBundleHash = false, currentBundleChanged = false, legacyBundle = false, bundleHashTampered = false } = {}) {
